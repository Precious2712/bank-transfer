...
export const AppProvider = ({ children }: AppProviderProps) => {
    ...
    const getUserBankAccountDetails = async () => {
        ...
        try {
            setIsLoading(true);
            const res = await axios.get<BankAccountResponse>(`http://localhost:3000/bank-account/${id}`);
    ...
    const fundBalance = async () => {
        ...
        try {
            const res = await axios.put(`http://localhost:3000/bank-account/${id}`, { balance });
    ...
    const searchField = async (filter: SearchFilter): Promise<SearchResult | null> => {
        ...
        try {
            ...
            const res = await axios.get<{
                ...
                "http://localhost:3000/bank-account/search",
                { params }
            );
    ...
    const credit = async () => {
        try {
            ...
            const alertForCredit = await axios.post(
                "http://localhost:3000/credit/create",
                obj
            );
    ...
    const debitTransfer = async () => {
        try {
            ...
            const res = await axios.post('http://localhost:3000/debit/create', obj);
    ...
    const fetchDebitTransaction = async () => {
        ...
        try {
            setIsRolling(true);
            const res = await axios.get<DebitRefResponse>(`http://localhost:3000/debit/${id}`);
            seDebitRef(res.data);
            // console.log(res);
    ...
    const fetchCreditTransaction = async () => {
        ...
        try {
            ...
            const res = await axios.get<CreditRefResponse>(`http://localhost:3000/credit/${id}`);
            console.log("✅ Response:", res.data);
